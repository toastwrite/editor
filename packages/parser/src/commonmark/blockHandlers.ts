...
import { alertBlockQuoteFinalize } from './gfm/alertBlockQuote';
import {
  table,
  tableHead,
  tableBody,
...
import { ListNode, BlockNode, BlockQuoteNode, CodeBlockNode, HtmlBlockNode } from './node';
import {
  peek,
  isBlank,
  isSpaceOrTab,
...
const blockQuote: BlockHandler = {
  ...
  finalize(_parser, block) {
    alertBlockQuoteFinalize(_parser, block as BlockQuoteNode);
  },
  canContain(t) {
    return t !== 'item';
  },
